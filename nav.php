...
$drop = "<ul><li id='drop-one' class='drop-li'><a href='signin.php' class='drop-link'>Sign In</a></li><li id='drop-two' class='drop-li'><a href='createAccount.php' class='drop-link'>Create Account</a></li></ul>";

if(isset($_SESSION['password'])){
    $drop = "<ul><li id='drop-one' class='drop-li'><a href='Logout.php' class='drop-link'>Logout</a></li></ul>";
    echo"<a href='index.php' id='logo-link'><img src=\"images/slither-logo.png\" id=\"logo-under\"></a>
    <div id=\"contain\">
        <div id=\"div1\">
            <ul>
