...
<div id="center-table">
    <table cellspacing="130" style="border-left: 1px;">
        ...
        <tr>
            <td class="gameop"><img src="https://upload.wikimedia.org/wikipedia/en/8/8c/A7800_Galaga.png" style="width: 200px;height: 200px;"><h5>Game 4</h5></td>
            <td class="gameop"><img src="http://vignette4.wikia.nocookie.net/doom/images/2/21/E1M1_imps.png/revision/latest?cb=20090215170556" style="width: 200px;height: 200px;"><h5>Game 5</h5></td>
            <td class="gameop"><img src="http://cinemassacre.com/wp-content/uploads/2015/10/mkfight.jpg" style="width: 200px;height: 200px;"><h5>Game 6</h5></td>
        </tr>
        <tr>
